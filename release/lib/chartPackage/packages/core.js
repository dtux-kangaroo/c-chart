...
var _temp = function () {
  ...
  __REACT_HOT_LOADER__.register(BarChart, 'BarChart', 'src/chartPackage/packages/core.js');

  __REACT_HOT_LOADER__.register(_default, 'default', 'src/chartPackage/packages/core.js');
}();
