...
var _temp = function () {
  ...
  __REACT_HOT_LOADER__.register(RingChart, 'RingChart', 'src/chartPackage/packages/ring/index.js');

  __REACT_HOT_LOADER__.register(_default, 'default', 'src/chartPackage/packages/ring/index.js');
}();
