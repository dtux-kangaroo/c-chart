...
var _temp = function () {
  ...
  __REACT_HOT_LOADER__.register(WordcloudChart, 'WordcloudChart', 'src/chartPackage/packages/wordcloud/index.js');

  __REACT_HOT_LOADER__.register(_default, 'default', 'src/chartPackage/packages/wordcloud/index.js');
}();
