...
var _temp = function () {
  ...
  __REACT_HOT_LOADER__.register(DEFAULT_THEME, 'DEFAULT_THEME', 'src/chartPackage/packages/constants.js');

  __REACT_HOT_LOADER__.register(DEFAULT_COLORS, 'DEFAULT_COLORS', 'src/chartPackage/packages/constants.js');

  __REACT_HOT_LOADER__.register(HEAT_MAP_COLOR, 'HEAT_MAP_COLOR', 'src/chartPackage/packages/constants.js');

  __REACT_HOT_LOADER__.register(HEAT_BMAP_COLOR, 'HEAT_BMAP_COLOR', 'src/chartPackage/packages/constants.js');

  __REACT_HOT_LOADER__.register(itemPoint, 'itemPoint', 'src/chartPackage/packages/constants.js');

  __REACT_HOT_LOADER__.register(STATIC_PROPS, 'STATIC_PROPS', 'src/chartPackage/packages/constants.js');

  __REACT_HOT_LOADER__.register(ECHARTS_SETTINGS, 'ECHARTS_SETTINGS', 'src/chartPackage/packages/constants.js');
}();
