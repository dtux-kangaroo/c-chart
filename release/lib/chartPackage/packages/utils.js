...
var _temp = function () {
  ...
  __REACT_HOT_LOADER__.register(getFormated, 'getFormated', 'src/chartPackage/packages/utils.js');

  __REACT_HOT_LOADER__.register(getStackMap, 'getStackMap', 'src/chartPackage/packages/utils.js');

  __REACT_HOT_LOADER__.register($get, '$get', 'src/chartPackage/packages/utils.js');

  __REACT_HOT_LOADER__.register(mapPromise, 'mapPromise', 'src/chartPackage/packages/utils.js');

  __REACT_HOT_LOADER__.register(getMapJSON, 'getMapJSON', 'src/chartPackage/packages/utils.js');

  __REACT_HOT_LOADER__.register(bmapPromise, 'bmapPromise', 'src/chartPackage/packages/utils.js');

  __REACT_HOT_LOADER__.register(amapPromise, 'amapPromise', 'src/chartPackage/packages/utils.js');

  __REACT_HOT_LOADER__.register(getBmap, 'getBmap', 'src/chartPackage/packages/utils.js');

  __REACT_HOT_LOADER__.register(getAmap, 'getAmap', 'src/chartPackage/packages/utils.js');

  __REACT_HOT_LOADER__.register(setArrayValue, 'setArrayValue', 'src/chartPackage/packages/utils.js');
}();
