...
var _temp = function () {
  ...
  __REACT_HOT_LOADER__.register(HistogramChart, 'HistogramChart', 'src/chartPackage/packages/histogram/index.js');

  __REACT_HOT_LOADER__.register(_default, 'default', 'src/chartPackage/packages/histogram/index.js');
}();
