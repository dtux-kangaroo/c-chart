...
exports.ring = exports.pie = undefined;
  ...
  if (level) {
    level.forEach(function (levelItems, index) {
      levelItems.forEach(function (item) {
        (0, _utils.setArrayValue)(levelTemp, item, index);
      });
    });
    innerRows.forEach(function (row) {
      ...
      if (itemLevel && itemLevel.length) {
        itemLevel.forEach(function (levelItem) {
          (0, _utils.setArrayValue)(rowsTemp, levelItem, row);
        });
      }
    });
  } else {
      ...
      seriesItem.label = {
        normal: {
          ...
          formatter: function formatter(item) {
            var tpl = [];
            tpl.push(item.name + ':');
            tpl.push((0, _utils.getFormated)(item.value, dataType, digit));
    ...
    formatter: function formatter(item) {
      ...
      if (limitShowNum && item.name === '其他') {
        ...
        remainArr.forEach(function (_ref) {
          ...
          var percent = (0, _utils.getFormated)(value / sum, 'percent');
          tpl.push('<br>' + name + ':');
          tpl.push((0, _utils.getFormated)(value, dataType, digit));
          tpl.push('(' + percent + ')');
        });
      } else {
        tpl.push(item.name + ':');
...
var pie = exports.pie = function pie(columns, rows, settings, extra, isRing) {
...
var ring = exports.ring = function ring(columns, rows, settings, extra) {
...
var _temp = function () {
  ...
  __REACT_HOT_LOADER__.register(pieRadius, 'pieRadius', 'src/chartPackage/packages/pie/main.js');

  __REACT_HOT_LOADER__.register(ringRadius, 'ringRadius', 'src/chartPackage/packages/pie/main.js');

  __REACT_HOT_LOADER__.register(roseRingRadius, 'roseRingRadius', 'src/chartPackage/packages/pie/main.js');

  __REACT_HOT_LOADER__.register(pieOffsetY, 'pieOffsetY', 'src/chartPackage/packages/pie/main.js');

  __REACT_HOT_LOADER__.register(getPieSeries, 'getPieSeries', 'src/chartPackage/packages/pie/main.js');

  __REACT_HOT_LOADER__.register(getPieLegend, 'getPieLegend', 'src/chartPackage/packages/pie/main.js');

  __REACT_HOT_LOADER__.register(getPieTooltip, 'getPieTooltip', 'src/chartPackage/packages/pie/main.js');

  __REACT_HOT_LOADER__.register(pie, 'pie', 'src/chartPackage/packages/pie/main.js');

  __REACT_HOT_LOADER__.register(ring, 'ring', 'src/chartPackage/packages/pie/main.js');
}();
