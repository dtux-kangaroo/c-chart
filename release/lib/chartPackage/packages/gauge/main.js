...
var _temp = function () {
  ...
  __REACT_HOT_LOADER__.register(getTooltip, 'getTooltip', 'src/chartPackage/packages/gauge/main.js');

  __REACT_HOT_LOADER__.register(getSeries, 'getSeries', 'src/chartPackage/packages/gauge/main.js');

  __REACT_HOT_LOADER__.register(gauge, 'gauge', 'src/chartPackage/packages/gauge/main.js');
}();
