...
var _temp = function () {
  ...
  __REACT_HOT_LOADER__.register(GaugeChart, 'GaugeChart', 'src/chartPackage/packages/gauge/index.js');

  __REACT_HOT_LOADER__.register(_default, 'default', 'src/chartPackage/packages/gauge/index.js');
}();
