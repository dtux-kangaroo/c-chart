  ...
  return {
    ...
    formatter: function formatter(options) {
      ...
      options.forEach(function (option) {
        ...
        tpl.push((0, _constants.itemPoint)(color) + ' ' + name + ': ');
        if (componentSubType === 'candlestick') {
          tpl.push('<br>');
          metrics.slice(0, 4).forEach(function (m, i) {
            var name = labelMap[m] != null ? labelMap[m] : m;
            var val = (0, _utils.getFormated)(data[i + 1], dataType, digit);
            tpl.push('- ' + name + ': ' + val + '<br>');
          });
        } else if (componentSubType === 'line') {
          var val = (0, _utils.getFormated)(data, dataType, digit);
          tpl.push(val + '<br>');
        } else if (componentSubType === 'bar') {
          var _val = (0, _utils.getFormated)(data[1], dataType, digit);
          tpl.push(_val + '<br>');
        }
      });
      return tpl.join('');
...
function getCandleYAxis(args) {
  ...
  var formatter = function formatter(val) {
    return (0, _utils.getFormated)(val, dataType, digit);
  };
...
var candle = exports.candle = function candle(columns, rows, settings, status) {
  ...
  var isLiteData = (0, _utilsLite.isArray)(rows[0]);
  var dims = [];
  var values = [];
  var volumes = [];
...
var _temp = function () {
  ...
  __REACT_HOT_LOADER__.register(DEFAULT_MA, 'DEFAULT_MA', 'src/chartPackage/packages/candle/main.js');

  __REACT_HOT_LOADER__.register(DEFAULT_K_NAME, 'DEFAULT_K_NAME', 'src/chartPackage/packages/candle/main.js');

  __REACT_HOT_LOADER__.register(DEFAULT_DOWN_COLOR, 'DEFAULT_DOWN_COLOR', 'src/chartPackage/packages/candle/main.js');

  __REACT_HOT_LOADER__.register(DEFAULT_UP_COLOR, 'DEFAULT_UP_COLOR', 'src/chartPackage/packages/candle/main.js');

  __REACT_HOT_LOADER__.register(DEFAULT_START, 'DEFAULT_START', 'src/chartPackage/packages/candle/main.js');

  __REACT_HOT_LOADER__.register(DEFAULT_END, 'DEFAULT_END', 'src/chartPackage/packages/candle/main.js');

  __REACT_HOT_LOADER__.register(SHOW_FALSE, 'SHOW_FALSE', 'src/chartPackage/packages/candle/main.js');

  __REACT_HOT_LOADER__.register(getCandleLegend, 'getCandleLegend', 'src/chartPackage/packages/candle/main.js');

  __REACT_HOT_LOADER__.register(getCandleTooltip, 'getCandleTooltip', 'src/chartPackage/packages/candle/main.js');

  __REACT_HOT_LOADER__.register(getCandleVisualMap, 'getCandleVisualMap', 'src/chartPackage/packages/candle/main.js');

  __REACT_HOT_LOADER__.register(getCandleGrid, 'getCandleGrid', 'src/chartPackage/packages/candle/main.js');

  __REACT_HOT_LOADER__.register(getCandleXAxis, 'getCandleXAxis', 'src/chartPackage/packages/candle/main.js');

  __REACT_HOT_LOADER__.register(getCandleYAxis, 'getCandleYAxis', 'src/chartPackage/packages/candle/main.js');

  __REACT_HOT_LOADER__.register(getCandleDataZoom, 'getCandleDataZoom', 'src/chartPackage/packages/candle/main.js');

  __REACT_HOT_LOADER__.register(getCandleSeries, 'getCandleSeries', 'src/chartPackage/packages/candle/main.js');

  __REACT_HOT_LOADER__.register(calculateMA, 'calculateMA', 'src/chartPackage/packages/candle/main.js');

  __REACT_HOT_LOADER__.register(candle, 'candle', 'src/chartPackage/packages/candle/main.js');
}();
