...
function getWaterfallTooltip(dataType, digit) {
  return {
    ...
    formatter: function formatter(items) {
      var item = items[1];
      return [item.name + '<br/>' + item.seriesName + ' :', '' + (0, _utils.getFormated)(item.value, dataType, digit)].join('');
    }
  };
}
    ...
    label: {
      normal: {
        ...
        formatter: function formatter(item) {
          return (0, _utils.getFormated)(item.value, dataType, digit);
        }
      }
    },
    data: mainData
...
var waterfall = exports.waterfall = function waterfall(columns, rows, settings, extra) {
...
var _temp = function () {
  ...
  __REACT_HOT_LOADER__.register(getWaterfallTooltip, 'getWaterfallTooltip', 'src/chartPackage/packages/waterfall/main.js');

  __REACT_HOT_LOADER__.register(getWaterfallXAxis, 'getWaterfallXAxis', 'src/chartPackage/packages/waterfall/main.js');

  __REACT_HOT_LOADER__.register(getWaterfallYAxis, 'getWaterfallYAxis', 'src/chartPackage/packages/waterfall/main.js');

  __REACT_HOT_LOADER__.register(getWaterfallSeries, 'getWaterfallSeries', 'src/chartPackage/packages/waterfall/main.js');

  __REACT_HOT_LOADER__.register(getWaterfallRemainStatus, 'getWaterfallRemainStatus', 'src/chartPackage/packages/waterfall/main.js');

  __REACT_HOT_LOADER__.register(waterfall, 'waterfall', 'src/chartPackage/packages/waterfall/main.js');
}();
