...
var _temp = function () {
  ...
  __REACT_HOT_LOADER__.register(HeatChart, 'HeatChart', 'src/chartPackage/packages/heatmap/index.js');

  __REACT_HOT_LOADER__.register(_default, 'default', 'src/chartPackage/packages/heatmap/index.js');
}();
