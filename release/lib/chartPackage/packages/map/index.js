...
var _temp = function () {
  ...
  __REACT_HOT_LOADER__.register(MapChart, 'MapChart', 'src/chartPackage/packages/map/index.js');

  __REACT_HOT_LOADER__.register(_default, 'default', 'src/chartPackage/packages/map/index.js');
}();
