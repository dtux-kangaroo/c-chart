...
var _temp = function () {
  ...
  __REACT_HOT_LOADER__.register(getTooltip, 'getTooltip', 'src/chartPackage/packages/map/main.js');

  __REACT_HOT_LOADER__.register(getSeries, 'getSeries', 'src/chartPackage/packages/map/main.js');

  __REACT_HOT_LOADER__.register(setGeoLabel, 'setGeoLabel', 'src/chartPackage/packages/map/main.js');

  __REACT_HOT_LOADER__.register(getLegendMap, 'getLegendMap', 'src/chartPackage/packages/map/main.js');

  __REACT_HOT_LOADER__.register(registerMap, 'registerMap', 'src/chartPackage/packages/map/main.js');

  __REACT_HOT_LOADER__.register(map, 'map', 'src/chartPackage/packages/map/main.js');
}();
