...
function getTooltipContent(item, args) {
  ...
  tpl.push((0, _constants.itemPoint)(color) + ' ' + seriesName + '<br>');
  value.forEach(function (d, i) {
    var name = labelMap[columns[i]] || columns[i];
    var num = isNaN(d) ? d : (0, _utils.getFormated)(d, dataType[columns[i]], digit);
  ...
  return {
    ...
    axisLabel: {
      formatter: function formatter(val) {
        return (0, _utils.getFormated)(val, dataType[metrics[0]], digit);
      }
    }
  };
}
...
var scatter = function scatter(columns, rows, settings, extra) {
  ...
  if ((0, _utilsLite.isArray)(rows)) {
    ...
    var options = (0, _main.line)(columns, rows, lineSettings, extra);
...
var _temp = function () {
  ...
  __REACT_HOT_LOADER__.register(getScatterLegend, 'getScatterLegend', 'src/chartPackage/packages/scatter/main.js');

  __REACT_HOT_LOADER__.register(getScatterTooltip, 'getScatterTooltip', 'src/chartPackage/packages/scatter/main.js');

  __REACT_HOT_LOADER__.register(getTooltipContent, 'getTooltipContent', 'src/chartPackage/packages/scatter/main.js');

  __REACT_HOT_LOADER__.register(getScatterXAxis, 'getScatterXAxis', 'src/chartPackage/packages/scatter/main.js');

  __REACT_HOT_LOADER__.register(getScatterYAxis, 'getScatterYAxis', 'src/chartPackage/packages/scatter/main.js');

  __REACT_HOT_LOADER__.register(getScatterSeries, 'getScatterSeries', 'src/chartPackage/packages/scatter/main.js');

  __REACT_HOT_LOADER__.register(scatter, 'scatter', 'src/chartPackage/packages/scatter/main.js');
}();
