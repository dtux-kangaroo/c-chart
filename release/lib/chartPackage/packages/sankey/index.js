...
var _temp = function () {
    ...
    __REACT_HOT_LOADER__.register(SankeyChart, 'SankeyChart', 'src/chartPackage/packages/sankey/index.js');

    __REACT_HOT_LOADER__.register(_default, 'default', 'src/chartPackage/packages/sankey/index.js');
}();
