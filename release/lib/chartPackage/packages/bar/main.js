...
var _temp = function () {
  ...
  __REACT_HOT_LOADER__.register(VALUE_AXIS_OPACITY, 'VALUE_AXIS_OPACITY', 'src/chartPackage/packages/bar/main.js');

  __REACT_HOT_LOADER__.register(getBarDimAxis, 'getBarDimAxis', 'src/chartPackage/packages/bar/main.js');

  __REACT_HOT_LOADER__.register(getValueAxisData, 'getValueAxisData', 'src/chartPackage/packages/bar/main.js');

  __REACT_HOT_LOADER__.register(getBarMeaAxis, 'getBarMeaAxis', 'src/chartPackage/packages/bar/main.js');

  __REACT_HOT_LOADER__.register(getBarTooltip, 'getBarTooltip', 'src/chartPackage/packages/bar/main.js');

  __REACT_HOT_LOADER__.register(getValueData, 'getValueData', 'src/chartPackage/packages/bar/main.js');

  __REACT_HOT_LOADER__.register(getBarSeries, 'getBarSeries', 'src/chartPackage/packages/bar/main.js');

  __REACT_HOT_LOADER__.register(getLegend, 'getLegend', 'src/chartPackage/packages/bar/main.js');

  __REACT_HOT_LOADER__.register(getDims, 'getDims', 'src/chartPackage/packages/bar/main.js');

  __REACT_HOT_LOADER__.register(bar, 'bar', 'src/chartPackage/packages/bar/main.js');

  __REACT_HOT_LOADER__.register(histogram, 'histogram', 'src/chartPackage/packages/bar/main.js');
}();
