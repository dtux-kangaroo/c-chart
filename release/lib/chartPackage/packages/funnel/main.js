...
function getFunnelTooltip(dataType, digit) {
  return {
    ...
    formatter: function formatter(item) {
      ...
      tpl.push(item.name + ': ' + (0, _utils.getFormated)(item.data.realValue, dataType, digit));
      return tpl.join('');
    }
  };
}
...
var funnel = exports.funnel = function funnel(outerColumns, outerRows, settings, extra) {
...
var _temp = function () {
  ...
  __REACT_HOT_LOADER__.register(getFunnelTooltip, 'getFunnelTooltip', 'src/chartPackage/packages/funnel/main.js');

  __REACT_HOT_LOADER__.register(getFunnelLegend, 'getFunnelLegend', 'src/chartPackage/packages/funnel/main.js');

  __REACT_HOT_LOADER__.register(getFunnelSeries, 'getFunnelSeries', 'src/chartPackage/packages/funnel/main.js');

  __REACT_HOT_LOADER__.register(funnel, 'funnel', 'src/chartPackage/packages/funnel/main.js');
}();
