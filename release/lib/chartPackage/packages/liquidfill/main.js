...
var _temp = function () {
  ...
  __REACT_HOT_LOADER__.register(getTooltip, 'getTooltip', 'src/chartPackage/packages/liquidfill/main.js');

  __REACT_HOT_LOADER__.register(getSeries, 'getSeries', 'src/chartPackage/packages/liquidfill/main.js');

  __REACT_HOT_LOADER__.register(liquidfill, 'liquidfill', 'src/chartPackage/packages/liquidfill/main.js');
}();
