      ...
      yAxis[i] = Object.assign({}, yAxisBase, {
        axisLabel: {
          formatter: function formatter(val) {
            return (0, _utils.getFormated)(val, yAxisType[i], digit);
          }
        }
      });
    } else {
  ...
  return {
    ...
    formatter: function formatter(items) {
      ...
      items.forEach(function (_ref) {
        ...
        var itemData = (0, _utilsLite.isArray)(data) ? data[1] : data;
        showData = (0, _utils.getFormated)(itemData, type, digit);
        tpl.push(marker);
...
var line = exports.line = function line(columns, rows, settings, extra) {
  rows = (0, _utilsLite.isArray)(rows) ? rows : [];
  columns = (0, _utilsLite.isArray)(columns) ? columns : [];
...
var _temp = function () {
  ...
  __REACT_HOT_LOADER__.register(getLineXAxis, 'getLineXAxis', 'src/chartPackage/packages/line/main.js');

  __REACT_HOT_LOADER__.register(getLineSeries, 'getLineSeries', 'src/chartPackage/packages/line/main.js');

  __REACT_HOT_LOADER__.register(getLineYAxis, 'getLineYAxis', 'src/chartPackage/packages/line/main.js');

  __REACT_HOT_LOADER__.register(getLineTooltip, 'getLineTooltip', 'src/chartPackage/packages/line/main.js');

  __REACT_HOT_LOADER__.register(getLegend, 'getLegend', 'src/chartPackage/packages/line/main.js');

  __REACT_HOT_LOADER__.register(line, 'line', 'src/chartPackage/packages/line/main.js');
}();
