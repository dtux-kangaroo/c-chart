...
var _temp = function () {
    ...
    __REACT_HOT_LOADER__.register(DataEmpty, 'DataEmpty', 'src/components/data-empty.js');

    __REACT_HOT_LOADER__.register(_default, 'default', 'src/components/data-empty.js');
}();
