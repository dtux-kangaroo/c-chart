...
var _temp = function () {
  ...
  __REACT_HOT_LOADER__.register(getRadarLegend, 'getRadarLegend', 'src/packages/radar/main.js');

  __REACT_HOT_LOADER__.register(getRadarTooltip, 'getRadarTooltip', 'src/packages/radar/main.js');

  __REACT_HOT_LOADER__.register(getRadarSetting, 'getRadarSetting', 'src/packages/radar/main.js');

  __REACT_HOT_LOADER__.register(getRadarSeries, 'getRadarSeries', 'src/packages/radar/main.js');

  __REACT_HOT_LOADER__.register(radar, 'radar', 'src/packages/radar/main.js');
}();
