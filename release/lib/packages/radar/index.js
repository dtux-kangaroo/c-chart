...
var _temp = function () {
  ...
  __REACT_HOT_LOADER__.register(RadarChart, 'RadarChart', 'src/packages/radar/index.js');

  __REACT_HOT_LOADER__.register(_default, 'default', 'src/packages/radar/index.js');
}();
