...
var _temp = function () {
  ...
  __REACT_HOT_LOADER__.register(getWaterfallTooltip, 'getWaterfallTooltip', 'src/packages/waterfall/main.js');

  __REACT_HOT_LOADER__.register(getWaterfallXAxis, 'getWaterfallXAxis', 'src/packages/waterfall/main.js');

  __REACT_HOT_LOADER__.register(getWaterfallYAxis, 'getWaterfallYAxis', 'src/packages/waterfall/main.js');

  __REACT_HOT_LOADER__.register(getWaterfallSeries, 'getWaterfallSeries', 'src/packages/waterfall/main.js');

  __REACT_HOT_LOADER__.register(getWaterfallRemainStatus, 'getWaterfallRemainStatus', 'src/packages/waterfall/main.js');

  __REACT_HOT_LOADER__.register(waterfall, 'waterfall', 'src/packages/waterfall/main.js');
}();
