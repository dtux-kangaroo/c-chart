...
var _temp = function () {
  ...
  __REACT_HOT_LOADER__.register(getLineXAxis, 'getLineXAxis', 'src/packages/line/main.js');

  __REACT_HOT_LOADER__.register(getLineSeries, 'getLineSeries', 'src/packages/line/main.js');

  __REACT_HOT_LOADER__.register(getLineYAxis, 'getLineYAxis', 'src/packages/line/main.js');

  __REACT_HOT_LOADER__.register(getLineTooltip, 'getLineTooltip', 'src/packages/line/main.js');

  __REACT_HOT_LOADER__.register(getLegend, 'getLegend', 'src/packages/line/main.js');

  __REACT_HOT_LOADER__.register(line, 'line', 'src/packages/line/main.js');
}();
