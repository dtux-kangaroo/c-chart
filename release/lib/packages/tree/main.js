...
var _temp = function () {
  ...
  __REACT_HOT_LOADER__.register(getTreeLegend, 'getTreeLegend', 'src/packages/tree/main.js');

  __REACT_HOT_LOADER__.register(getTreeTooltip, 'getTreeTooltip', 'src/packages/tree/main.js');

  __REACT_HOT_LOADER__.register(getTreeSeries, 'getTreeSeries', 'src/packages/tree/main.js');

  __REACT_HOT_LOADER__.register(tree, 'tree', 'src/packages/tree/main.js');
}();
