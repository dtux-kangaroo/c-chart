...
var _temp = function () {
  ...
  __REACT_HOT_LOADER__.register(pieRadius, 'pieRadius', 'src/packages/pie/main.js');

  __REACT_HOT_LOADER__.register(ringRadius, 'ringRadius', 'src/packages/pie/main.js');

  __REACT_HOT_LOADER__.register(roseRingRadius, 'roseRingRadius', 'src/packages/pie/main.js');

  __REACT_HOT_LOADER__.register(pieOffsetY, 'pieOffsetY', 'src/packages/pie/main.js');

  __REACT_HOT_LOADER__.register(getPieSeries, 'getPieSeries', 'src/packages/pie/main.js');

  __REACT_HOT_LOADER__.register(getPieLegend, 'getPieLegend', 'src/packages/pie/main.js');

  __REACT_HOT_LOADER__.register(getPieTooltip, 'getPieTooltip', 'src/packages/pie/main.js');

  __REACT_HOT_LOADER__.register(pie, 'pie', 'src/packages/pie/main.js');

  __REACT_HOT_LOADER__.register(ring, 'ring', 'src/packages/pie/main.js');
}();
