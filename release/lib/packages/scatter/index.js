...
var _temp = function () {
  ...
  __REACT_HOT_LOADER__.register(ScatterChart, 'ScatterChart', 'src/packages/scatter/index.js');

  __REACT_HOT_LOADER__.register(_default, 'default', 'src/packages/scatter/index.js');
}();
