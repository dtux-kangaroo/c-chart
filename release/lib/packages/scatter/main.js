...
var _temp = function () {
  ...
  __REACT_HOT_LOADER__.register(getScatterLegend, 'getScatterLegend', 'src/packages/scatter/main.js');

  __REACT_HOT_LOADER__.register(getScatterTooltip, 'getScatterTooltip', 'src/packages/scatter/main.js');

  __REACT_HOT_LOADER__.register(getTooltipContent, 'getTooltipContent', 'src/packages/scatter/main.js');

  __REACT_HOT_LOADER__.register(getScatterXAxis, 'getScatterXAxis', 'src/packages/scatter/main.js');

  __REACT_HOT_LOADER__.register(getScatterYAxis, 'getScatterYAxis', 'src/packages/scatter/main.js');

  __REACT_HOT_LOADER__.register(getScatterSeries, 'getScatterSeries', 'src/packages/scatter/main.js');

  __REACT_HOT_LOADER__.register(scatter, 'scatter', 'src/packages/scatter/main.js');
}();
