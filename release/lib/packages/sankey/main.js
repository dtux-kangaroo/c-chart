...
var _temp = function () {
  ...
  __REACT_HOT_LOADER__.register(getTooltip, 'getTooltip', 'src/packages/sankey/main.js');

  __REACT_HOT_LOADER__.register(getSeries, 'getSeries', 'src/packages/sankey/main.js');

  __REACT_HOT_LOADER__.register(sankey, 'sankey', 'src/packages/sankey/main.js');
}();
