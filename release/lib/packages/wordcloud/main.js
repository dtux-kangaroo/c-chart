...
var _temp = function () {
  ...
  __REACT_HOT_LOADER__.register(getSeries, 'getSeries', 'src/packages/wordcloud/main.js');

  __REACT_HOT_LOADER__.register(getTooltip, 'getTooltip', 'src/packages/wordcloud/main.js');

  __REACT_HOT_LOADER__.register(wordcloud, 'wordcloud', 'src/packages/wordcloud/main.js');
}();
