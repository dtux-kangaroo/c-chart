...
var _temp = function () {
  ...
  __REACT_HOT_LOADER__.register(CandleChart, 'CandleChart', 'src/packages/candle/index.js');

  __REACT_HOT_LOADER__.register(_default, 'default', 'src/packages/candle/index.js');
}();
