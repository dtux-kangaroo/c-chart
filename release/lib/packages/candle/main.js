...
var _temp = function () {
  ...
  __REACT_HOT_LOADER__.register(DEFAULT_MA, 'DEFAULT_MA', 'src/packages/candle/main.js');

  __REACT_HOT_LOADER__.register(DEFAULT_K_NAME, 'DEFAULT_K_NAME', 'src/packages/candle/main.js');

  __REACT_HOT_LOADER__.register(DEFAULT_DOWN_COLOR, 'DEFAULT_DOWN_COLOR', 'src/packages/candle/main.js');

  __REACT_HOT_LOADER__.register(DEFAULT_UP_COLOR, 'DEFAULT_UP_COLOR', 'src/packages/candle/main.js');

  __REACT_HOT_LOADER__.register(DEFAULT_START, 'DEFAULT_START', 'src/packages/candle/main.js');

  __REACT_HOT_LOADER__.register(DEFAULT_END, 'DEFAULT_END', 'src/packages/candle/main.js');

  __REACT_HOT_LOADER__.register(SHOW_FALSE, 'SHOW_FALSE', 'src/packages/candle/main.js');

  __REACT_HOT_LOADER__.register(getCandleLegend, 'getCandleLegend', 'src/packages/candle/main.js');

  __REACT_HOT_LOADER__.register(getCandleTooltip, 'getCandleTooltip', 'src/packages/candle/main.js');

  __REACT_HOT_LOADER__.register(getCandleVisualMap, 'getCandleVisualMap', 'src/packages/candle/main.js');

  __REACT_HOT_LOADER__.register(getCandleGrid, 'getCandleGrid', 'src/packages/candle/main.js');

  __REACT_HOT_LOADER__.register(getCandleXAxis, 'getCandleXAxis', 'src/packages/candle/main.js');

  __REACT_HOT_LOADER__.register(getCandleYAxis, 'getCandleYAxis', 'src/packages/candle/main.js');

  __REACT_HOT_LOADER__.register(getCandleDataZoom, 'getCandleDataZoom', 'src/packages/candle/main.js');

  __REACT_HOT_LOADER__.register(getCandleSeries, 'getCandleSeries', 'src/packages/candle/main.js');

  __REACT_HOT_LOADER__.register(calculateMA, 'calculateMA', 'src/packages/candle/main.js');

  __REACT_HOT_LOADER__.register(candle, 'candle', 'src/packages/candle/main.js');
}();
