...
var _temp = function () {
  ...
  __REACT_HOT_LOADER__.register(FunnelChart, 'FunnelChart', 'src/packages/funnel/index.js');

  __REACT_HOT_LOADER__.register(_default, 'default', 'src/packages/funnel/index.js');
}();
