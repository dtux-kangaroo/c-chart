...
var _temp = function () {
  ...
  __REACT_HOT_LOADER__.register(getFunnelTooltip, 'getFunnelTooltip', 'src/packages/funnel/main.js');

  __REACT_HOT_LOADER__.register(getFunnelLegend, 'getFunnelLegend', 'src/packages/funnel/main.js');

  __REACT_HOT_LOADER__.register(getFunnelSeries, 'getFunnelSeries', 'src/packages/funnel/main.js');

  __REACT_HOT_LOADER__.register(funnel, 'funnel', 'src/packages/funnel/main.js');
}();
