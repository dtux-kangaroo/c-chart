...
var _temp = function () {
  ...
  __REACT_HOT_LOADER__.register(getAxisList, 'getAxisList', 'src/packages/heatmap/main.js');

  __REACT_HOT_LOADER__.register(getData, 'getData', 'src/packages/heatmap/main.js');

  __REACT_HOT_LOADER__.register(getAxis, 'getAxis', 'src/packages/heatmap/main.js');

  __REACT_HOT_LOADER__.register(getVisualMap, 'getVisualMap', 'src/packages/heatmap/main.js');

  __REACT_HOT_LOADER__.register(getSeries, 'getSeries', 'src/packages/heatmap/main.js');

  __REACT_HOT_LOADER__.register(getTooltip, 'getTooltip', 'src/packages/heatmap/main.js');

  __REACT_HOT_LOADER__.register(heatmap, 'heatmap', 'src/packages/heatmap/main.js');
}();
